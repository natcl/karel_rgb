...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-4",
					"items" : [ "AU DLS Synth 1", ",", "Réseau Session 1", ",", "from Max 1", ",", "from Max 2", ",", "to Max Runtime 1", ",", "to Max Runtime 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-5",
					"items" : [ "Réseau Session 1", ",", "to Max 1", ",", "to Max 2", ",", "from Max Runtime 1", ",", "from Max Runtime 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
